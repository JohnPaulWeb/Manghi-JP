...
<section>
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <header>
      <h2 className="text-xl font-bold text-gray-900 sm:text-3xl">Philippines Product</h2>
      ...
      <div className="hidden space-y-4 lg:block">
        <div>
          ...
          <select id="SortBy" className="mt-1 rounded border-gray-300 text-sm">
            ...
            <option value="Title, DESC">Strawberry</option>
            <option value="Title, ASC">Sushi</option>
            <option value="Price, DESC">Strawberry</option>
            <option value="Price, ASC">Pancake</option>
          </select>
        </div>
            ...
            <a href="#" className="group block overflow-hidden">
              ...
              <div className="relative bg-white pt-3">
                ...
                <p className="mt-2">
                  ...
                  <span className="tracking-wider text-gray-900"> Yummy </span>
                </p>
              </div>
            </a>
          </li>
